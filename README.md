...
## Struktura Modelu
    ...
    Assumptions: Centralny panel sterowania zmiennymi modelu.

    Forecast: 5-letnia prognoza operacyjna i finansowa (FCFF).

    Valuation: Kalkulacja WACC, Equity Bridge oraz wycena końcowa.
...
## Kluczowe Aspekty Techniczne
    ...
    Dynamiczny WACC: Koszt kapitału własnego (Ke​) bazuje na modelu CAPM z uwzględnieniem malejącej stopy wolnej od ryzyka (4,5% do 4,0%) i bety sektora (0,74).

    Analiza XIRR: Wykazanie implikowanej stopy zwrotu na poziomie 2,3% – poniżej rentowności obligacji skarbowych (4,5%).
...
## Wnioski
    ...
    Dino (P/E 32,4x) notowane jest z blisko 100% premią względem Jeronimo Martins (16,6x).

    Prognozowana kompresja marży EBIT do 6,1% ze względu na presję płacową i konkurencję.
...
## Model Structure
    ...
    Assumptions: Centralized input panel for all model drivers.

    Forecast: 5-year operating forecast and Free Cash Flow (FCFF) projections.

    Valuation: WACC calculation, Equity Bridge, and final intrinsic value.
...
## Technical Highlights
    ...
    Dynamic WACC: Cost of equity (Ke​) derived via CAPM, incorporating a declining Risk-Free Rate (4.5% to 4.0%) and sector Beta (0.74).

    XIRR Analysis: Market-implied annual return of 2.3%, significantly below the 4.5% risk-free yield.
...
## Key Findings
    ...
    Dino (32.4x P/E) trades at a nearly 100% premium compared to Jeronimo Martins (16.6x).

    Forecasted EBIT margin compression to 6.1% due to labor cost pressure and retail price wars.
